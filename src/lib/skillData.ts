...
export const roles: RoleData[] = ([
  ...
  },
  {
    ...
    skills: [
      { name: "Requirements Gathering", category: "core", demandLevel: 95 },
      { name: "Stakeholder Management", category: "core", demandLevel: 92 },
      { name: "SQL", category: "core", demandLevel: 85 },
      { name: "Business Process Modelling", category: "core", demandLevel: 88 },
      { name: "User Stories", category: "core", demandLevel: 90 },
      { name: "JIRA", category: "supporting", demandLevel: 78 },
      { name: "Confluence", category: "supporting", demandLevel: 65 },
      { name: "Data Analysis", category: "supporting", demandLevel: 72 },
      { name: "Agile Methodologies", category: "supporting", demandLevel: 80 },
      { name: "Power BI", category: "supporting", demandLevel: 60 },
      { name: "Excel", category: "supporting", demandLevel: 70 },
      { name: "Wireframing", category: "supporting", demandLevel: 55 },
      { name: "UML", category: "differentiator", demandLevel: 45 },
      { name: "Python", category: "differentiator", demandLevel: 40 },
      { name: "Tableau", category: "differentiator", demandLevel: 42 },
      { name: "Six Sigma", category: "differentiator", demandLevel: 35 },
      { name: "BPMN", category: "differentiator", demandLevel: 38 },
    ],
  },
  {
    label: "Product Owner",
    value: "product-owner",
    skills: [
      { name: "Product Backlog Management", category: "core", demandLevel: 95 },
      { name: "Stakeholder Management", category: "core", demandLevel: 93 },
      { name: "User Stories", category: "core", demandLevel: 92 },
      { name: "Agile Methodologies", category: "core", demandLevel: 90 },
      { name: "Prioritisation Frameworks", category: "core", demandLevel: 88 },
      { name: "JIRA", category: "supporting", demandLevel: 82 },
      { name: "Roadmap Planning", category: "supporting", demandLevel: 78 },
      { name: "Data-Driven Decision Making", category: "supporting", demandLevel: 72 },
      { name: "A/B Testing", category: "supporting", demandLevel: 55 },
      { name: "Confluence", category: "supporting", demandLevel: 65 },
      { name: "SQL", category: "supporting", demandLevel: 50 },
      { name: "Wireframing", category: "supporting", demandLevel: 58 },
      { name: "OKRs", category: "differentiator", demandLevel: 48 },
      { name: "Product Analytics", category: "differentiator", demandLevel: 45 },
      { name: "SAFe", category: "differentiator", demandLevel: 38 },
      { name: "Market Research", category: "differentiator", demandLevel: 42 },
